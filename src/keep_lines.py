...
# encoding: utf-8
'''
analysis.keeps_lines -- Keeps a list of lines (specified by their numbers) from
an input file.

analysis.keeps_lines is script that keeps lines from a text file. The lines are
...
''' % (program_shortdesc, str(__date__))
    ...
    try:
        ...
        parser.add_argument("keep_lines", action="store",
                            help="File containing the line numbers to keep.")
        ...
        try:
            lines_file = codecs.open(args.keep_lines, 'r')
